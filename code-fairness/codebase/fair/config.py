...
parser.add_argument('--user_feature_path', type=str, default=None, help="The mode of weight")
parser.add_argument('--item_feature_path', type=str, default=None, help="The mode of weight")
parser.add_argument('--feature_data', type=bool, default=False, help="The mode of weight")
parser.add_argument('--lambda_impression', type=float, default=0.8, help='The mean of gaussian kernel')
parser.add_argument('--lambda_click', type=float, default=0.8, help='The mean of gaussian kernel')
parser.add_argument('--experiment_id', type=int, default=0, help="User embedding dimension")
# Used to be an option, but now is solved
parser.add_argument('--impression_or_click', type=str, default='impression', help="User embedding dimension")
# pretrain_arg.add_argument('--pretrain_type',type=str,default='wasserstein',choices=['wasserstein','gan'])
parser.add_argument('--user_dim', type=int, default=300, help="User embedding dimension")
...
parser.add_argument('--item_size', type=int, default=1000, help="Item number")
...
parser.add_argument('--debias_mode', type=str, default='Noweight',
                    choices=['Catboost', 'Noweight', 'IPM', 'DensityRatio', 'IPM_Embedding', 'Adversarial', 'Fairness'], help="The mode of weight")
parser.add_argument('--use_sensitive', type=str2bool, default=True, help="Use sensitive as input")
parser.add_argument('--no_disentangle', type=str2bool, default=False, help="Use disentangle or not")
...
parser.add_argument('--data_path', type=str, default='data_nonuniform_marital.csv')
...
# fairness
parser.add_argument('--test_sensitive_group', type=str, default='user', help='Sensitive group in test data')
parser.add_argument('--user_group_size', type=int, default=2, help='User sensitive group size')
parser.add_argument('--item_group_size', type=int, default=18, help='Item sensitive group size')
