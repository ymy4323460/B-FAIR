...
#      for debias in True
#      do
#        for data in movielens #insurance
#        do
...
#                --data_path data_nonuniform_movie_tag_age.csv
##          python3 train_fair.py \
##                --debias_mode Fairness \
##                --is_debias $debias \
##                --downstream $down \
...
##                --embedding_classweight 1 1 \
##                --lambda_impression $lambda_impression\
##                --test_sensitive_group user \
##                --data_path data_nonuniform_gender.csv
##
##          python3 train_fair.py \
##                --debias_mode Fairness \
##                --is_debias $debias \
...
##                --lambda_impression $lambda_impression\
##                --test_sensitive_group user \
##                --data_path data_nonuniform_marital.csv
##
##          python train_adv.py \
...
do
  ...
  do
    ...
    do
      for debias in True
      do
        for data in nonlinearinvdata_25_32_0.1
        do
          python3 train_fair.py \
                --debias_mode Fairness \
                --is_debias $debias \
...
for confoun in False
do
  for down in gmfBPR #mlpBPR NeuBPR gmfBPR MLP
  do
    for debias in False
    do
      for data in nonlinearinvdata_25_32 #movielens #insurance #nonlinearinvdata_25_32 nonlinearinvdata_50_32
      do
#        python3 train_fair.py \
#                --debias_mode Adversarial \
#                --is_debias $debias \
